...
class GreSettingsAPI:
    """
    OPNsense Interfaces GRE Settings API
    module: interfaces
    controller: gre_settings
    """

    def __init__(self, client: OPNsenseClient):
        self.client = client
        self.base = "/api/interfaces/gre_settings"
    ...
    def get_if_options(self):
        return self.client.get(f"{self.base}/get_if_options")
